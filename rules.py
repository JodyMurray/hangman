...
def rules_page():
    ...
    rule_list = (
        '\n1: The hangman should consist of a head, a body, 2 arms, and 2'
        ' legs.'
        '\n'
        '\n2: If the player correctly guesses all of the letters before the'
        ' hangman is complete, they win.'
        '\n'
        '\n3: If they loose lives, the drawing of the HANGMAN is complete and'
        'you lose.'
        '\n'
