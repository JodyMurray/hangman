...
Scores = SCORESHEETS.get_all_values()
...
def update_scores(new_score):
    ...
    """
    print(f"Updating {SCORESHEETS} score worksheet...\n")
    worksheet_to_update = Scores.worksheet(SCORESHEETS)
    worksheet_to_update.append_row(Scores)
    print(f"{SCORESHEETS} worksheet updated successfully\n")
...
#     hangman_game = game()
#     update_worksheet(new_score, "scores")
#     scores = display_highscores()
